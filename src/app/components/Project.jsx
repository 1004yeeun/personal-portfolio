                ...
                <div className="flex-1">
                    ...
                    <div className="flex gap-4 pt-2">
                        {github && (
                            ...
                            >
                                <FaGithub className="text-xl" onClick={ () => {playClick();} } /> <span className="hidden md:block lg:block" onClick={ () => {playClick();} }>source code</span>
                            </a>
                        )}
                        {link && (
                            <a
                                ...
                                className="inline-flex items-center gap-1.5 text-sm text-[#c7c4c0] hover:text-black transition"
                            >
                                <BiWorld className="text-xl" onClick={ () => {playClick();} } /> <span className="hidden md:block lg:block" onClick={ () => {playClick();} }>live demo</span>
                            </a>
                        )}
                    </div>
                </div>
